      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <td><input size="70" type="text" name="model" value="<?php echo $model; ?>" />
                <?php if ($error_model) { ?>
        ...
        <td></td>
            ...
            <tr class="hide">
              ...
              <td><input size="70" type="text" name="sku" value="<?php echo $sku; ?>" /></td>
            </tr>
      <tr class="hide">
              <td><?php echo $entry_upc; ?></td>
              <td><input size="70" type="text" name="upc" value="<?php echo $upc; ?>" /></td>
            </tr>
            <tr class="hide">
              <td><?php echo $entry_ean; ?></td>
              <td><input size="70" type="text" name="ean" value="<?php echo $ean; ?>" /></td>
            </tr>
            <tr class="hide">
              <td><?php echo $entry_jan; ?></td>
              <td><input size="70" type="text" name="jan" value="<?php echo $jan; ?>" /></td>
            </tr>
            <tr class="hide">
              <td><?php echo $entry_isbn; ?></td>
              <td><input size="70" type="text" name="isbn" value="<?php echo $isbn; ?>" /></td>
            </tr>
            <tr class="hide">
              <td><?php echo $entry_mpn; ?></td>
              <td><input size="70" type="text" name="mpn" value="<?php echo $mpn; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_location; ?></td>
              <td><input size="70" type="text" name="location" value="<?php echo $location; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_price; ?></td>
              <td><input size="70" type="text" name="price" value="<?php echo $price; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input size="70" type="text" name="quantity" value="<?php echo $quantity; ?>" size="5" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_minimum; ?></td>
              <td><input size="70" type="text" name="minimum" value="<?php echo $minimum; ?>" size="4" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input type="text" size="100" name="keyword" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_product_memory; ?></td>
              <td><input size="70" type="text" name="product_memory_value" value="<?php echo $product_memory_value; ?>" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_product_color; ?></td>
              <td>
              <div id="colorSelector">
                <div style="background-color: <?php echo $product_color_value; ?>;"></div>
                <input style="display: none;" id="colorSelectorValue" type="text" name="product_color_value" value="<?php echo $product_color_value; ?>" /></td>
              </div>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input size="70" type="text" name="date_available" value="<?php echo $date_available; ?>" size="12" class="date" /></td>
            </tr>
            <tr>
              <td><?php echo $entry_dimension; ?></td>
              <td><input size="70" type="text" name="length" value="<?php echo $length; ?>" size="4" />
                <input size="70" type="text" name="width" value="<?php echo $width; ?>" size="4" />
                <input size="70" type="text" name="height" value="<?php echo $height; ?>" size="4" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input size="70" type="text" name="weight" value="<?php echo $weight; ?>" /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input size="70" type="text" name="sort_order" value="<?php echo $sort_order; ?>" size="2" /></td>
            </tr>
          </table>
        </div>
        <div id="tab-links">
          <table class="form">
            ...
            <tr>
              <td>&nbsp;</td>
              <td><div id="product-color" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($product_color as $product_color) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-color<?php echo $product_color['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_color['name']; ?><img src="view/image/delete.png" alt="" />
            ...
            <tr>
              <td><?php echo $entry_memory; ?></td>
              <td><input type="text" name="memory" value="" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td><div id="product-memory" class="scrollbox">
                  <?php $class = 'odd'; ?>
                  <?php foreach ($product_memory as $product_memory) { ?>
                  <?php $class = ($class == 'even' ? 'odd' : 'even'); ?>
                  <div id="product-memory<?php echo $product_memory['product_id']; ?>" class="<?php echo $class; ?>"> <?php echo $product_memory['name']; ?><img src="view/image/delete.png" alt="" />
                    <input type="hidden" name="product_memory[]" value="<?php echo $product_memory['product_id']; ?>" />
                  </div>
                  <?php } ?>
                </div></td>
            </tr>
          ...
          <table id="attribute" class="list">
            <thead>
              <tr>
                ...
                <td class="left"><?php echo $entry_f_text; ?></td>
                <td class="left"><?php echo $entry_short; ?></td>
                <td></td>
              </tr>
            </thead>
            <?php $attribute_row = 0; ?>
            ...
            <tbody id="attribute-row<?php echo $attribute_row; ?>">
              <tr>
                ...
                <td class="left"><?php foreach ($languages as $language) { ?>
                  ...
                  <?php } ?></td>
                <td class="left"><?php foreach ($languages as $language) { ?>
                <textarea name="product_attribute[<?php echo $attribute_row; ?>][product_attribute_description][<?php echo $language['language_id']; ?>][f_text]" cols="40" rows="5"><?php echo isset($product_attribute['product_attribute_description'][$language['language_id']]) ? $product_attribute['product_attribute_description'][$language['language_id']]['f_text'] : ''; ?></textarea>
                <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />
                <?php } ?></td> 
                <td><select name="product_attribute[<?php echo $attribute_row; ?>][short]">
                  <?php if ($product_attribute['short']) { ?>
                  <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
...
$('input[name=\'color\']').autocomplete({
  ...
  select: function(event, ui) {
    $('#product-color' + ui.item.value).remove();
    
    $('#product-color').append('<div id="product-color' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="product_color[]" value="' + ui.item.value + '" /></div>');

    $('#product-color div:odd').attr('class', 'odd');
    $('#product-color div:even').attr('class', 'even');
...
$('#product-color div img').live('click', function() {
  $(this).parent().remove();
...
// Memory
$('input[name=\'memory\']').autocomplete({
  delay: 500,
  source: function(request, response) {
    $.ajax({
      url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
  ...
  select: function(event, ui) {
    $('#product-memory' + ui.item.value).remove();
    
    $('#product-memory').append('<div id="product-memory' + ui.item.value + '">' + ui.item.label + '<img src="view/image/delete.png" alt="" /><input type="hidden" name="product_memory[]" value="' + ui.item.value + '" /></div>');

    $('#product-memory div:odd').attr('class', 'odd');
    $('#product-memory div:even').attr('class', 'even');
...
$('#product-memory div img').live('click', function() {
  $(this).parent().remove();
...
function addAttribute() {
  ...
  html += '<td class="left">';
  <?php foreach ($languages as $language) { ?>
  html += '<textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][f_text]" cols="40" rows="5"></textarea><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />';
  <?php } ?>
  html += '</td>';
  html += '<td>';
  html += '<select name="product_attribute[' + attribute_row + '][short]">';
...
//     $('.scrollbox').resizable();
  ...
  $("a.hidelink").click(function () {
    ...
    $('#colorSelector').ColorPicker({
      ...
      onBeforeShow: function () {
        ...
        // $(this).children('#colorSelectorValue').val(this.value);
      }
    })
    .bind('keyup', function(){
      // $(this).ColorPickerSetColor(this.value);
  ...
  function changeColor() {
    $('#colorSelectorValue').val($('#colorSelector > div').css('background-color'));
    $('#form').attr('action', '<?php echo html_entity_decode($action); ?>');
    $('#form').submit();
  }
...
<script type="text/javascript"><!--
    $(document).ready(function() {
        $.ajax({
            url: 'index.php?route=module/optionar/getTemplates&token=<?php echo $token; ?>',
            type: 'get',
            dataType: 'html',
            success: function(html) {
                $('#tab-option').prepend(html);
            }
        });
    });
    ...
    $('#add_option_templates').live('change', function() {
        $.ajax({
            url: 'index.php?route=module/optionar/addOptions&token=<?php echo $token; ?>',
            type: 'post',
            dataType: 'json',
            data: 'this_template_id=' + encodeURIComponent($('#add_option_templates').val()),
            success: function (json) {
                if (json != '') {
                    for (i = 0; i < json.length; i++) {
                        html  = '<div id="tab-option-' + option_row + '" class="vtabs-content">';
                        html += '	<input type="hidden" name="product_option[' + option_row + '][product_option_id]" value="" />';
                        html += '	<input type="hidden" name="product_option[' + option_row + '][name]" value="' + json[i]['name'] + '" />';
                        html += '	<input type="hidden" name="product_option[' + option_row + '][option_id]" value="' + json[i]['option_id'] + '" />';
                        html += '	<input type="hidden" name="product_option[' + option_row + '][type]" value="' + json[i]['type'] + '" />';
                        html += '	<table class="form">';
                        html += '	  <tr>';
                        html += '		<td><?php echo $entry_required; ?></td>';
                        html += '       <td><select name="product_option[' + option_row + '][required]">';
                        ...
                        if (json[i]['type'] == 'select' || json[i]['type'] == 'radio' || json[i]['type'] == 'checkbox' || json[i]['type'] == 'image') {
                            html += '  <table id="option-value' + option_row + '" class="list">';
                            html += '  	 <thead>';
                            html += '      <tr>';
                            html += '        <td class="left"><?php echo $entry_option_value; ?></td>';
                            ...
                            for (j = 0; j < json[i]['option_value'].length; j++) {
                                html += '  <option value="' + json[i]['option_value'][j]['option_value_id'] + '">' + json[i]['option_value'][j]['name'] + '</option>';
                            }
                        ...
                        $('#option-add').before('<a href="#tab-option-' + option_row + '" id="option-' + option_row + '">' + json[i]['name'] + '&nbsp;<img src="view/image/delete.png" alt="" onclick="$(\'#option-' + option_row + '\').remove(); $(\'#tab-option-' + option_row + '\').remove(); $(\'#vtab-option a:first\').trigger(\'click\'); return false;" /></a>');

                        if (typeof(json[i]['selected_option_value'][json[i]['option_id']]) != "undefined") {
                            console.log(json[i]['selected_option_value'][json[i]['option_id']].length);
                            for (selected_value in json[i]['selected_option_value'][json[i]['option_id']]) {
                                addOptionValue(option_row);
                                $('#option-value' + option_row + ' tbody:last select:first').val(selected_value);
                            }
                        }
    ...
    $('#delete_all_options').live('click', function() {
        if (!confirm('Удаление невозможно отменить! Вы уверены, что хотите это сделать?')) {
            return false;
        } else {
            $('#tab-option').children('.vtabs-content').remove();
            $('#tab-option').children('#vtab-option').children('a').remove();
        }
    });

    $('#delete_empty_options').live('click', function() {
        if (!confirm('Удаление невозможно отменить! Вы уверены, что хотите это сделать?')) {
            return false;
        } else {
            $('#tab-option .vtabs-content').each(function () {
                if ($(this).children('table.list').children('tbody').length == 0) {
                    var i = '#' + $(this).attr('id').replace('tab-', '');
		...
		success: function (json) {
			if (json != '') {
				for (i = 0; i < json.length; i++) {
					...
					html += '    <td class="left">';
					<?php foreach ($languages as $language) { ?>
					html += '<textarea name="product_attribute[' + attribute_row + '][product_attribute_description][<?php echo $language['language_id']; ?>][text]" cols="40" rows="5">' + json[i]['product_attribute_description'][<?php echo $language['language_id']; ?>] + '</textarea><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" align="top" /><br />';
  		 		    <?php } ?>
					html += '    </td>';
					html += '    <td class="left"><a onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
  		  		    html += '  </tr>';	
