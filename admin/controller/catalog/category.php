...
class ControllerCatalogCategory extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['entry_line'] = $this->language->get('entry_line');
		...
		if (isset($this->request->post['line'])) {
			...
			$this->data['line'] = $category_info['line'];
		} else {
			$this->data['line'] = 1;
		}

		if (isset($this->request->post['line_on'])) {
			$this->data['line_on'] = $this->request->post['line_on'];
		} elseif (!empty($category_info)) {
			$this->data['line_on'] = $category_info['line_on'];
		} else {
			$this->data['line_on'] = 1;
		}
