...
class ControllerCatalogInformation extends Controller { 
	...
	protected function getForm() {
		...
		$this->data['text_without_category'] = $this->language->get('text_without_category');
		...
		$this->data['categories'] = $this->model_catalog_information_category->getInformationCategories();
