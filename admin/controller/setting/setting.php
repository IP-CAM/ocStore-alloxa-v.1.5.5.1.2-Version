...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_delivery_text'])) {
			$this->data['config_delivery_text'] = $this->request->post['config_delivery_text'];
		} else {
			$this->data['config_delivery_text'] = $this->config->get('config_delivery_text');
		}

		if (isset($this->request->post['config_payment_text'])) {
			$this->data['config_payment_text'] = $this->request->post['config_payment_text'];
		} else {
			$this->data['config_payment_text'] = $this->config->get('config_payment_text');
		}

		if (isset($this->request->post['config_guarantee_text'])) {
			$this->data['config_guarantee_text'] = $this->request->post['config_guarantee_text'];
		} else {
			$this->data['config_guarantee_text'] = $this->config->get('config_guarantee_text');
		}
