...
class ControllerLocalisationCity extends Controller {
	...
	public function report_clear() {
		$this->load->model('localisation/city');
		$this->model_localisation_city->deleteReports();
		$this->report();
	}
	public function report() {
		...
		$this->data['heading_title'] = 'Лог ошибок';
		$this->data['clear'] = $this->url->link('localisation/city/report_clear', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$this->data['button_clear'] = 'Очистить лог';
		
		$this->data['reports'] = $this->model_localisation_city->getReports();
		
		$this->template = 'localisation/novapochta.tpl';
	...
	protected function getList() {
		...
		$this->data['report'] = $this->url->link('localisation/city/report', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$this->data['button_report'] = $this->language->get('button_report');
