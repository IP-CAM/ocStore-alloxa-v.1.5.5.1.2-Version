  ...
  <tr class="filter">
   ...
   <td class="center">
    <select name="limit" onchange="getProducts('&page=1');">
     ...
     <option value="500">500 (<strong>warning:</strong> browser crash)</option>
     <option value="1000">1000 (<strong>warning:</strong> browser crash)</option>
     <option value="2000">2000 (<strong>warning:</strong> browser crash)</option>
     <option value="5000">5000 (<strong>warning:</strong> browser crash)</option>
    </select>
   </td>
  </tr>
  <tr class="filter">
