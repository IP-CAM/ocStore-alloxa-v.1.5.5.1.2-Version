      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
            ...
            <tr>
                <td><?php echo $entry_delivery_text; ?></td>
                <td><textarea name="config_delivery_text" id="config_delivery_text"><?php echo $config_delivery_text; ?></textarea></td>
            </tr>
            <tr>
                <td><?php echo $entry_payment_text; ?></td>
                <td><textarea name="config_payment_text" id="config_payment_text"><?php echo $config_payment_text; ?></textarea></td>
            </tr>
            <tr>
                <td><?php echo $entry_guarantee_text; ?></td>
                <td><textarea name="config_guarantee_text" id="config_guarantee_text"><?php echo $config_guarantee_text; ?></textarea></td>
            </tr>
          </table>
        </div>
        <div id="tab-store">
...
<script type="text/javascript"><!--
    CKEDITOR.replace('config_delivery_text', {
    ...
    CKEDITOR.replace('config_payment_text', {
        filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
    ...
    CKEDITOR.replace('config_guarantee_text', {
        filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserFlashBrowseUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
        filebrowserUploadUrl: 'index.php?route=common/filemanager&token=<?php echo $token; ?>',
