...
<link rel="stylesheet" type="text/css" media="screen" href="view/javascript/colorpicker/css/colorpicker.css" />
<link rel="stylesheet" type="text/css" media="screen" href="view/javascript/colorpicker/css/layout.css" />
...
<div id="header">
  ...
  <div id="menu">
    ...
    <ul class="right" style="display: none;">
      <li><a style="margin: 5px;" href="<?php echo $clear_cache ?>" class="button"><span>Очистить кеш</span></a></li>
