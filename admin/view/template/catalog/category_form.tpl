        ...
        <span id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input size="100" type="text" name="keyword" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
             ...
             <tr>
              ...
              <td>
                <select name="line">
                  ...
                  <span style="margin-left: 20px;"><?php echo $text_enable; ?></span>
                  <select name="line_on">
                      <?php if ($line_on) { ?>
                      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                      <option value="0"><?php echo $text_disabled; ?></option>
...
<script type="text/javascript">
    ...
    function saveWH(obj_event) {
        ...
        delta_w = w_block - point[0]; // �������� ������� ������� ����� ������� � x-����������� ����
        delta_h = h_block - point[1]; // �������� ������� ������� ����� ������� � y-����������� ����
        /* ������ ��������� �������� ���� ��� ������ ��������� */
