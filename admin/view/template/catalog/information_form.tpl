          ...
          <table class="form">
            ...
            <tr>
              ...
              <td><select name="category_id">
                  <option value="0"><?php echo $text_without_category; ?></option>
                  <?php foreach($categories as $category) { ?>
                    <option <?php echo $category['information_category_id'] == $category_id ? 'selected="selected"' : ''; ?> value="<?php echo $category['information_category_id']; ?>"><?php echo $category['title']; ?></option>
                  <?php } ?>
                </select></td>
            </tr>
            <tr>
