      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($information_category['selected']) { ?>
              ...
              <td class="right"><?php echo $information_category['sort_order']; ?></td>
              <td class="right"><?php foreach ($information_category['action'] as $action) { ?>
