	...
	public function rewrite($link) {
		...
		switch ($route) {
			case 'information/information_category':
				if (isset($data['information_category_id'])) {
					$tmp = $data;
				}
				break;
		...
		if (isset($tmp) && array_key_exists('product_id', $tmp)) {
			$seo_url = 'catalog/' . $seo_url;
		} elseif (isset($tmp) && array_key_exists('information_category_id', $tmp)) {
