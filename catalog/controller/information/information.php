		...
		if ($information_info) {
			...
			if ($this->data['is_news']) {
				...
				$this->data['breadcrumbs'][] = array(
					...
					'href'      => $this->url->link('information/information_Category', 'information_category_id=' .  $this->request->get['information_category_id']),
					'separator' => $this->language->get('text_separator')
				);
			}

			$this->data['date_added'] = date('d.m.Y', strtotime($information_info['date_added']));
