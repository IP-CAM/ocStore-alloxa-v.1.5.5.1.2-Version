...
class ControllerPaymentCashless extends Controller {
	protected function index() {
		...
		$this->data['cashless'] = nl2br($this->config->get('cashless_bank_' . $this->config->get('config_language_id')));
	...
	public function confirm() {
		...
		$comment .= $this->config->get('cashless_bank_' . $this->config->get('config_language_id')) . "\n\n";
