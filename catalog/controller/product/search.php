...
class ControllerProductSearch extends Controller { 	
	public function index() { 
  	...
  	public function autocomplete() {
  		if (isset($this->request->post['search_word']) && !empty($this->request->post['search_word'])) {
  			$data = array(
				'filter_name'         => $this->request->post['search_word'], 
				'filter_tag'          => '', 
				'filter_description'  => '',
				'filter_category_id'  => 0, 
				'filter_sub_category' => '', 
			...
			$products['total'] = $product_total;
			$products['search_address'] = $this->url->link('product/search', 'search=' . $this->request->post['search_word']);
