...
class ControllerCheckoutSimpleCheckoutPaymentDescription extends Controller {
    public function index() {
        ...
        if (!empty($this->data['code'])) {
            $this->data['description'] = html_entity_decode(str_replace('sub_total', $total, $this->config->get($this->data['code'] . '_bank_1')));
        } else {
        ...
        $this->data['text_checkout_payment_method_description'] = $this->language->get('text_checkout_payment_method_description');
        
        if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/checkout/simplecheckout_payment_description.tpl')) {
            $this->template = $this->config->get('config_template') . '/template/checkout/simplecheckout_payment_description.tpl';
        } else {
            $this->template = 'default/template/checkout/simplecheckout_payment_description.tpl';
        }
