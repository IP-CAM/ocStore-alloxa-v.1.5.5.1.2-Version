...
class ModelCheckoutOrder extends Model {	
	public function addOrder($data) {
        ...
        //require_once($_SERVER['DOCUMENT_ROOT'] .'/ApekApi/InsertOrder.php');
		return $order_id;
	}
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'credit_post'              => $order_query->row['payment_credit']
			);
		} else {
			return false;	
		}
