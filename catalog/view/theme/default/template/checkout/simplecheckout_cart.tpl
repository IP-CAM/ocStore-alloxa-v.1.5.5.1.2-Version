                ...
                <?php } else { ?>
                    <?php foreach ($product['options'] as $option) { ?>
                        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
                            ...
                            <select onchange="simplecheckout_reload('option_change');" name="option[<?php echo $option['product_option_id']; ?>]">
                                <?php foreach ($option['option_value'] as $option_value) { ?>
                                <option <?php if ($product['option'][$option['product_option_id']]['product_option_value_id'] == $option_value['product_option_value_id']) { ?>selected="selected"<?php } ?> value="<?php echo $option_value['product_option_value_id']; ?>"><?php echo $option_value['name']; ?>
    ...
    <div class="simplecheckout-cart-total">
        <div class="box-product" style="text-align: center;">
          ...
          <div style="margin-bottom: 0px;">
            ...
            <?php } ?>
            <div class="name"><a style="font-size: 11px;text-align: left;color: #231f20;" href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></div>
            ...
            <?php } ?>
            <div class="cart"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="cart-related"><span>Купить</span></a></div>
          </div>
          <?php } ?>
        </div>
    </div>
