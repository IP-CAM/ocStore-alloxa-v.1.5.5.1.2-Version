...
<?php /* ?><div class="box-heading"><?php echo $heading_title; ?><div style="height: 15px; float: right;">
	<a class="clear_filter"><?php echo $clear_filter?></a></div></div><?php */ ?>
...
<div class="option_box price_slider_box" <?php if(!$price_slider) { echo 'style="display:none"';}?>>
<div class="option_name price_slider_name"><?php echo $text_price_range?></div>
<div class="price_slider collapsible">
	<div id="slider-range"></div>
	<?php /* if($symbol_left){ echo "<label>". $symbol_left  . "</label>";} */ ?>
	<label>от </label> <input maxlength="6" type="text" id="min_price" value="-1" name="min_price" class="price_limit">
	<label> до </label>
	<input maxlength="6" type="text" id="max_price" value="-1" name="max_price" class="price_limit">
	<button class="price_slider_ok">Ok</button>
...
<div class="option_box">
	...
	<?php if($attr_group) { ?>
	<div class="option_box">
		<?php /* ?><div class="attribute_group_name"><?php echo $attribute['name']; ?></div><?php */ ?>
	<?php } ?>
